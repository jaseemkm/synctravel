	...
	<section>
		<div class="tr-register">
			<div class="tr-regi-form">
				...
				<form class="col s12" action='insert' method='POST' enctype='multipart/form-data'>
					...
					<div class="row">
						<div class="input-field col s12">
							<input type="number" class="validate" name="price">
							<label>Price</label>
						</div>
					</div>
					<div class="row" id="seat">
						<div class="input-field col s12">
							<input type="number" class="validate" name="seat">
					...
					<div class="row">
						<div class="input-field col s12">
							<select  class="validate" name="per">
					...
					<div class="row">
						<div class="input-field col s12">
							<input type="text" class="validate" name="dis">
